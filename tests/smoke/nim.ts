...
// deepseek-v4-flash: current pick (2026-09-15). gpt-oss-20b returned
// empty/pseudo-JSON instead of tool calls in opencode's loop;
// qwen2.5-coder-32b is EOL since 2026-05-12. See nim-pilot.ts tool check.
