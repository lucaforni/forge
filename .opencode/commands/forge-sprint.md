...
Check `.forge/sprints/retrospectives/sprint-NN-retro.md` — the filename `/forge-retro` writes. Missing → non-blocking warning suggesting `/forge-retro NNN`. Exists → acknowledge.
